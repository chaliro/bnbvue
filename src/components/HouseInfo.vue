    ...
    <div class="common-layout">
        ...
        >
            <el-form :model="houseInfo">
                ...
                <div class="block">
                <div>营业状况</div>
                    <el-select v-model="houseInfo.state" class="m-2" placeholder="选择营业状况" size="default">
                        <el-option
...
export default {
    data(){
        return{
            ...
            houseInfoModel:{id:'', name:'', location:'', time:'', countNow:'', countTotal:'', state:'', description:''},
            houseInfo:{id:'', name:'', location:'', time:'', countNow:'', countTotal:'', state:'', description:''},
