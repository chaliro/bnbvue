<template>
      <div>
        <el-form ref="loginForm"   label-width="80px" class="login-box" v-loading="loading">
          <h3 class="login-title">欢迎登录旅游民宿系统</h3>
          <el-form-item label="账号" prop="username">
            <el-input type="text" placeholder="请输入账号" v-model="login.username"/>
          </el-form-item>
          <el-form-item label="密码" prop="password">
            <el-input type="password" placeholder="请输入密码" v-model="login.password"/>
          </el-form-item>
